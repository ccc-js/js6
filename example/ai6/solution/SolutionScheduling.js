...
function randSlot() {
  return uu6.randomInt(0, slots.length)
}

function randCourse() {
  return uu6.randomInt(0, courses.length)
}

class SolutionScheduling extends ai6.Solution {
